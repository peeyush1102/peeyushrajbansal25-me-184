...
Task 2 – Lane Detection Detecting lanes using color masks and Canny edge detection, then overlaying the drivable area on the road.

Task 3 – Obstacle & Pothole Detection Locating obstacles/potholes through blob detection, drawing bounding boxes, and reporting their coordinates.
